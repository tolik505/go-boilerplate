...
func init() {
	proto.RegisterType((*Post)(nil), "goboilerplate.Post")
	proto.RegisterType((*GetAllPostsRequest)(nil), "goboilerplate.GetAllPostsRequest")
	proto.RegisterType((*GetAllPostsResponse)(nil), "goboilerplate.GetAllPostsResponse")
}
...
var fileDescriptor_15a1dc8d40dadaa6 = []byte{
	...
	,
...
func (c *postsServiceClient) GetAllPosts(ctx context.Context, in *GetAllPostsRequest, opts ...grpc.CallOption) (*GetAllPostsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goboilerplate.PostsService/GetAllPosts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PostsService_GetAllPosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goboilerplate.PostsService/GetAllPosts",
	}
...
var _PostsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "goboilerplate.PostsService",
